function elipsoid_2nci_Temel_Odev(P1_Enlem, P1_Boylam, P2_Enlem, P2_Boylam) {
	...
	/*
		//Bessel elipsoidinin geometrik parametreleri
		var a = 6377397.155;
		var b = 6356078.9628;
		var c = Math.pow(a, 2) / b;
		var e2 = (Math.pow(a, 2) - Math.pow(b, 2)) / Math.pow(a, 2);
	...
	*/
	...
	Enlem1 = P1_Enlem //41.22762242 GRS80 ; // Deðiþecek
	Boylam1 = P1_Boylam //34.26611978 GRS80 ; // Deðiþecek
	Enlem2 = P2_Enlem //41.77188053 GRS80 ; // Deðiþecek
	Boylam2 = P2_Boylam //34.74943683 GRS80 ; // Deðiþecek
