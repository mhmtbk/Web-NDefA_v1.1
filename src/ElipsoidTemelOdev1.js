function elipsoid_1nci_Temel_Odev(P1_Enlem, P1_Boylam, P1P2_Uzunluk, P1P2_Azimut) {
	...
	Enlem = P1_Enlem ; //48.4459543, Değişecek
	Boylam = P1_Boylam // 10.7164782, Değişecek
	S= P1P2_Uzunluk ; // 47835.627, Uzunluk girilecek ya da koordinat farkına göre bir km hesaplanacak şekilde bir formül yazılacak
	azimut= P1P2_Azimut ; // 32.0925114, Değişecek
